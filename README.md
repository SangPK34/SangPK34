...
- Testing authentication, sessions, and input handling
- Reviewing HTML/JS source code

**Digital Forensics**
- File, metadata, and hidden data analysis
- Disk image and filesystem artifact inspection
